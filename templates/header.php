    ...
    <div class="container">
      <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
        ...
        <? if (isset($_COOKIE['sqpass'])):?>
          <a href="#" class="d-inline-block link-body-emphasis text-decoration-none" data-bs-toggle="dropdown" aria-expanded="false">
          <div class="dropdown text-end">
            ...
            <h3 class="fw-normal">
              ...
              require "../db.php";
              $uid = $_COOKIE['sqpass'];
              $query = $conn->query("SELECT * FROM Users WHERE id like $uid");
            ...
            <div class="d-inline-block">
            <img src="https://github.com/mdo.png" alt="mdo" width="32" height="32" class="rounded-circle h3">
            </div>
          </div>
        </a>
          <ul class="dropdown-menu text-small">
            ...
            <li><a class="dropdown-item" href="https://sql-tec.ru/logout">Выйти из Аккаунта</a></li>
          </ul>
        </div>
        <? else: ?>
